...
describe("Testing orderPage", () => {
  ...
  it("Paddle clicked later will open a new page", async () => {
    await Helper.scrollPage("1500");
    await Helper.moveClickItem(pricingPage.paddleButton);
    expect(await (await browser.getAllWindowHandles()).length).toBe(2);
  });

  it("Bank wire clicked later will open a new page", async () => {
    await Helper.scrollPage("1500");
  ...
  it("Stripe clicked later will move to home page", async () => {
    await Helper.scrollPage("1500");
    await Helper.moveClickItem(pricingPage.stripeButton);
    expect(await browser.getCurrentUrl()).toContain("phptravels");
  });
  ...
  it("Bank wire clicked later will move to home page", async () => {
    await Helper.scrollPage("1500");
    await Helper.moveClickItem(pricingPage.bankButton);
    expect(await browser.getCurrentUrl()).toContain("phptravels");
  });
